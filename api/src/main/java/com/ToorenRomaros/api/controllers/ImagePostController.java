...
public class ImagePostController {
    ...
    @Operation(
            ...
            description = "This endpoint allows users to add a new image to the file system for a specific Post. Users can upload an image file, specify the image type, and provide the film ID.",
            tags = { "Image", "Post", "post" })
    @ApiResponses({
    ...
    @SecurityRequirement(name = "Bearer Authentication", scopes = "CRITIC")
