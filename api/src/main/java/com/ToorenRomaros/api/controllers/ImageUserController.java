...
public class ImageUserController {
    ...
    public ImageUserController(@Qualifier("ImageServiceFilmImpl") ImageService imageService) {
        this.imageService = imageService;
    }

    @Operation(
            summary = "Create Image for User",
            description = "This endpoint allows users to add a new image to the file system for a specific User. Users can upload an image file, specify the image type, and provide the film ID.",
            tags = { "Image", "User", "post" })
    @ApiResponses({
    ...
    @SecurityRequirement(name = "Bearer Authentication", scopes = {"CRITIC", "USER"})
