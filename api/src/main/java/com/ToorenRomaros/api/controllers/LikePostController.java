...
public class LikePostController {
    ...
    public LikePostController(@Qualifier("LikeServicePostImpl") LikeService likeService) {
        this.likeService = likeService;
    }
    @Operation(
            summary = "Create Like-Post Relationship",
            description = "This endpoint allows users to increment like count for a specific Post. Users can specify the Post ID and user ID in the payload to establish the relationship.",
            tags = { "Like", "Post", "post" })
    @ApiResponses({
