...
public enum ErrorCode {
    ...
    ACCESS_DENIED("API-006", "Access Denied."),
    UNAUTHORIZED("API-007", "Unauthorized"),
    ...
    * custom exceptions*/
    ...
    RESOURCE_NOT_FOUND("API-0013", "Requested resource not found."),
    GENERIC_ALREADY_EXISTS("API-0014", "Already exists.");
