...
function Navbar({ handleSubmit, handleChange, formData }) {
                    ...
                    <div>
                        <ul className="flex flex-row items-center justify-between gap-4">
                            <li>
                                <Link
                                    to="/browse"
                                    className="hover:cursor-pointer hover:text-red-600 text-body-d-400"
                                >
                                    Movies
                                </Link>
                            </li>
                            ...
                            >
                                ...
                                <div className="p-8 rounded-md w-[596px] bg-white-50 z-50">
                                    ...
                                    <div className="flex flex-col items-start justify-center gap-4 p-4">
                                        ...
                                        <div
                                            className={`${
                                                active === 1 ? show : notShow
                                            }`}
                                        >
                                            <p className="text-white-700 text-small-m-400 lg:text-small-d-400 text-center w-full">
                                                Get started with a free Cinnabar
                                                account to rate, review, and
                                                discover top movies, TV shows,
                                                posts, and more!
                                            </p>
